...
"Any update planed?"
--------------------
Yes, i plan a quick short time update, to put the rest of the objects i want to give (but my mind for the moment
...
- I notify a random bug with the new unity lightmapper, sometime the lightmapper stay locked 
  on a calculating job (Jobs XXX/XXX)	

	The only soution i find is to reduce the lightmap resolution :
	=> Lightning window => General GI => Default parameters => Default-low resolution, maybe 
	   a shit with memory... i don't know...

 																																									
- Another strange stuff on imac, i work on imac I5 os 10.8.5, the rendering in rutime mode is 
  insanly slow! (no problem on pc)

	To fix it just check 'Compressed' in the lightning window. Maybe another shit about gfx memory 
	(My ATI Radeon HD 6770M 512 mo of ram)
